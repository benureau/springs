...
K = 8
arm_dims = 3 * [[(40, 30) for i in range(K)] + [(40, 0)]]
...
for birth_size, x in [(1.0, 960)]:
    ...
    starfish  = creatures.DevStarfish(space, arm_dims, (x, 540), 30,
...
if __name__ == '__main__':
    springs.create_display(space, width=1920, height=1080, zoom=1.0,
                           ...
                           screenshot_folder='/Users/fcyb/Data/Screens/201911_movie/threearms/threearms',
