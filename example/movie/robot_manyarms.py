...
K = 20
arm_dims = 12 * [[(40, 30) for i in range(K)] + [(40, 0)]]
...
materials = {
    ...
    'link_sec_side'    : {'stiffness':   10000.0, 'damping_ratio': 1.0, 'actuated':  True},
...
speeds = None
for birth_size, x in [(1.0, 1920)]:

    starfish  = creatures.DevStarfish(space, arm_dims, (x, 1080), 50,
...
if __name__ == '__main__':
    springs.create_display(space,
                           # width=1920, height=1080,
                           width=3840, height=2160,
                           zoom=1.0,
                           duration=60, spf=0.02,
                           screenshot_folder='/Users/fcyb/Data/Screens/201911_movie/manyarms/manyarms',
